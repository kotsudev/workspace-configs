# Generated by Powerlevel10k configuration wizard on 2024-04-20 at 13:26 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49778.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# vertical separators, slanted heads, flat tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#45465A'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#45465A'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#45465A'
